        ...
        <div className="col-md-6">
          ...
          <div className="user_register-group-box">
            ...
            <form id="addform" className="user_registration_form">
              <input type="hidden" name="roll" value="customer" />
              <div className="row">
        ...
        if (res.error == true) {
          ...
          setTimeout(() => {
            window.location.href =
              "/website/appuser/otpget?id=" + res.data._id + "";
          }, 1000);
        }
      })
...
export default App_userregister
